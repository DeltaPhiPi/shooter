...
export function wasm_bindgen__convert__closures__invoke1_mut__h0966e77b35e384af(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__h121459617bb3e77f(a: number, b: number, c: number, d: number): void;
export function wasm_bindgen__convert__closures__invoke0_mut__haeef40a64e3a13b7(a: number, b: number): void;
