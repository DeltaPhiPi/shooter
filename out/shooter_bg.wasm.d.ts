...
export function wasm_bindgen__convert__closures__invoke0_mut__hcbf510e9e5a61513(a: number, b: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__hfca3967a0d2013a8(a: number, b: number, c: number, d: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__h06800255353309ad(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke0_mut__hacfef35455853fdb(a: number, b: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__h05eda1f89a0b6c42(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke0_mut__hb03057cd17fcce79(a: number, b: number): void;
